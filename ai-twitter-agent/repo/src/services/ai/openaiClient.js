...
class BrowserOpenAIClient {
  ...
  async generateTweet(topic, options = {}) {
    console.log('BrowserOpenAIClient.generateTweet called');
    console.log('Environment check - isExtension:', this.isExtension);
    
    if (this.isExtension) {
      console.log('Using background script for OpenAI API call');
...
export default BrowserOpenAIClient; 