...
const Dashboard = () => {
  ...
  useEffect(() => {
        ...
        try {
          ...
          if (accounts.length > 0) {
            ...
            chrome.storage.local.set(
              ...
              () => {
                console.log(
                  "✅ Wallet address stored in chrome.storage:",
                  accounts[0]
                );
              }
            );
    ...
    const handleAccountsChanged = (accounts) => {
      if (accounts.length > 0) {
        ...
        chrome.storage.local.set(
          ...
          () => {
            console.log(
              "✅ Wallet address updated in chrome.storage:",
              accounts[0]
            );
          }
        );
    ...
    const handleDisconnect = async () => {
      console.log(
        "🔄 Starting wallet disconnect and Twitter shutdown process..."
      );
      ...
      chrome.storage.local.set(
        ...
        () => {
          ...
          chrome.runtime.sendMessage(
            ...
            () => {
              console.log(
                "✅ Sent stop signal to all active scraping processes"
              );
            }
          );
        }
  ...
  return (
    <div className="min-h-screen w-full p-4" style={{ backgroundImage: `url('/wood.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
      <div className="max-w-3xl mx-auto h-[calc(100vh-2rem)] flex items-center justify-center">
        <div className="bg-white/65 backdrop-blur-sm rounded-2xl shadow-lg p-5 mb-4 border border-black flex items-center justify-center">
