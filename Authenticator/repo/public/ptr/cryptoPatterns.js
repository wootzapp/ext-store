...
const cryptoPatterns = {
   ...
   bitcoin: {
    ...
    twelveWordSeedPhrase: {
        type: "12-Word Seed Phrase",
        pattern: XRegExp(`(?:\\b${bip39WordList}\\b(?:\\s*\\b${bip39WordList}\\b){6})`, 'i'),
        description: "Matches 12-word seed phrases using common BIP-39 word lists.",
        tags: ["Crypto", "Seed Phrase", "12-Word"]
    },
    eighteenWordSeedPhrase: {
        type: "18-Word Seed Phrase",
        pattern: XRegExp(`(?:\\b${bip39WordList}\\b(?:\\s*\\b${bip39WordList}\\b){8})`, 'i'),
        description: "Matches 18-word seed phrases using common BIP-39 word lists.",
        tags: ["Crypto", "Seed Phrase", "18-Word"]
    },
    twentyFourWordSeedPhrase: {
        type: "24-Word Seed Phrase",
        pattern: XRegExp(`(?:\\b${bip39WordList}\\b(?:\\s*\\b${bip39WordList}\\b){12})`, 'i'),
        description: "Matches 24-word seed phrases using common BIP-39 word lists.",
        tags: ["Crypto", "Seed Phrase", "24-Word"]
    }
